...
<body>
  ...
  <div class="container-fluid">
    ...
    <table class="table table-bordered">
      ...
      foreach ($produk  as $data) {
        ...
        echo "<td> <a href='Admin/Ui_admin/Editsiswa/$data->id'><button class='btn btn-primary btn-xs'>Edit</button></a></td>";
  ...
  <script>
    function produk(id) {
      document.getElementById("test").innerHTML = "jalan";
      $('#form_hapus')[0].reset();
      $.ajax({
        url: "<?php echo base_url('Home/Get') ?>/" + id,
        type: "GET",
        dataType: "JSON",
